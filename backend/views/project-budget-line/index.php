...
/* @var $searchModel backend\models\ProjectBudgetLineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Project Budget Lines';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="project-budget-line-index">
    ...
    <p>
        <?= Html::a('Create Project Budget Line', ['create'], ['class' => 'btn btn-success']); ?>
    </p>
