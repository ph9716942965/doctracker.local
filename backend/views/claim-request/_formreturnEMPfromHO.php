...
?>
 ...
 <button type="button" class="btn btn-primary" id="returnemp" data-toggle="modal" data-target="#myModal2">
 Return to Employee
</button>
...
<div class="form-group">
  ...
  <div class="col-md-10">                     
    <textarea class="form-control" id="comment2" placeholder="Emp Return Comment here" name="comment2" required></textarea>
  </div>
</div>
<!-- Button (Double) -->
<div class="form-group">
  ...
  <div class="col-md-8">
      ...
      <button onclick="ajaxcomment2()" class="btn btn-success">Save </button> 
