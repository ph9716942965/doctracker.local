                ...
                <div class="row">
                    <div class="col-md-4">
                        <div style="border:1px dotted darkblue;padding: 10px">
                            <?= $form->field($model, 'file_purchase_request_apporval')->fileInput(); ?>
                        ...
                        <!--<br><br>-->
                        <div style="border:1px dotted darkblue;padding: 10px">
                            <?= $form->field($model, 'file_purchase_order')->fileInput(); ?>
                            <?php if ($model->isNewRecord == false) {
                                ?>
                    ...
                    <div class="col-md-4">
                        <div style="border:1px dotted darkblue;padding: 10px">
                            <?= $form->field($model, 'file_quotation')->fileInput(); ?>
                            <?php if ($model->isNewRecord == false) {
                                ?>
                        ...
                        <!--<br><br>-->
                        <div style="border:1px dotted darkblue;padding: 10px">
                            <?= $form->field($model, 'file_pro_forma_final_invoice')->fileInput(); ?>
                            <?php if ($model->isNewRecord == false) {
                                ?>
                    ...
                    <div class="col-md-4">
                        <div style="border:1px dotted darkblue;padding: 10px">
                            <?= $form->field($model, 'file_purchase_commite')->fileInput(); ?>
                            <?php if ($model->isNewRecord == false) {
                                ?>
